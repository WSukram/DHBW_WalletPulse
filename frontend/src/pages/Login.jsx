      ...
      <main className="flex-grow pt-[120px] pb-24 relative flex items-center justify-center">
        ...
        <div aria-hidden="true" className="pointer-events-none absolute inset-x-0 top-0 h-[720px] overflow-hidden">
          ...
          <div
            ...
            style={{ background: `radial-gradient(closest-side, ${t.BLOB_LAV}, transparent 70%)`, filter: 'blur(10px)' }}
          />
          <div
            className="absolute top-10 -right-24 w-[380px] h-[380px] rounded-full"
            style={{ background: `radial-gradient(closest-side, ${t.BLOB_CREAM}, transparent 70%)`, filter: 'blur(10px)' }}
          />
        </div>

        <section className="relative w-full max-w-[440px] px-6">
          {/* Eyebrow */}
          <div
          ...
          >
            Sign in to your portfolio and pick up right where you left off.
          </p>
